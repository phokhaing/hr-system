<form action="{{ route('report.getStaffActive') }}" role="form" method="get" id="report_contract">
    {{ csrf_field() }}
    <input type="hidden" name="is_download" id="is_download">
    <input type="hidden" name="is_report_active" value="1">
    <div class="row">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        ...
                        <select class="form-control contract_type" name="contract_type">
                            <option value="" selected>>> {{ __('Contract active type') }} <<</option>
                            {!! SELECT_ALL !!}
                            @foreach(CONTRACT_ACTIVE_TYPE as $key => $value)
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        ...
                        <select name="position_code" id="position_code" class="form-control position_code select2">
