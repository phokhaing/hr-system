        ...
        @if(isset($contracts))
            @foreach($contracts as $key => $contract)
                @php
                    ...
                    $array_flip = array_flip(CONTRACT_ACTIVE_TYPE);
                ...
                <tr>
                    ...
                    <td>
                        {{ @$contract->contract_type == CONTRACT_ACTIVE_TYPE['PROBATION'] ?
                        find_duration_contract(@$contract->start_date,
                        @$contract->contract_object['probation_end_date']) : 'N/A'}}
                    </td>
                    <td>
                        @if($documentContract)
