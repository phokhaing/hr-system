<div class="row">
    <div class="col-sm-12 col-md-12">
        <form action="{{ route('contract.storeLayOff') }}" role="form" method="post" id="create_contract" enctype="multipart/form-data">

            {{ csrf_field() }}
            <input type="hidden" name="contract_type" value="{{CONTRACT_TYPE['LAY_OFF']}}">
            ...
            <div class="row">
                <div class="form-group col-sm-6 col-md-6 col-lg-6 @if($errors->has('layoff_effective_date')) has-error @endif">
                    <label for="layoff_effective_date">Effective date <span class="text-danger">*</span></label>
                    <input type="text" class="pull-right form-control layoff_effective_date" id="layoff_effective_date" name="layoff_effective_date" readonly
                           placeholder="ថ្ងៃ-ខែ-ឆ្នាំ {{ __('label.effective_date') }}" autocomplete="off" value="{{ old('layoff_effective_date') }}" required>
                </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6 col-md-6 col-lg-6 @if($errors->has('contract_layoff_transfer_to_id')) has-error @endif">
                    <label for="contract_layoff_transfer_to_id">Transfer work to (Staff ID) <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="contract_layoff_transfer_to_id" id="contract_layoff_transfer_to_id"
                           placeholder="{{ __('label.transfer_work_to').' ('.__('label.employee_id').')' }}" value="{{ old('contract_layoff_transfer_to_id') }}" required>
                </div>
