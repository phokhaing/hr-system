<div class="row">
    <div class="col-sm-12 col-md-12">
        <form action="{{ route('contract.storePromote') }}" role="form" method="post" id="create_contract" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-6 @if($errors->has('contract_promote_start_date')) has-error @endif">
                    <label for="contract_promote_start_date">Contract start date <span class="text-danger">*</span></label>
                    <input type="text" class="form-control pull-right contract_start_date" id="contract_promote_start_date" readonly
                           value="{{ old('contract_promote_start_date') }}" required
                           name="contract_promote_start_date" placeholder="{{ __('label.contract_start_date') }}">
                </div>
                <div class="form-group col-sm-12 col-md-6 col-lg-6 @if($errors->has('contract_promote_end_date')) has-error @endif">
                    <label for="contract_promote_end_date">Contract end date <span class="text-danger">*</span></label>
                    <input type="text" class="form-control pull-right contract_end_date" id="contract_promote_end_date" readonly
                           value="{{ old('contract_promote_end_date') }}" required
                           name="contract_promote_end_date" placeholder="{{ __('label.contract_end_date') }}">
                </div>

                <div class="form-group col-sm-6 col-md-6 col-lg-6 @if($errors->has('promote_effective_date')) has-error @endif">
                    <label for="promote_effective_date">Effective date <span class="text-danger">*</span></label>
                    <input type="text" class="pull-right form-control promote_effective_date" id="promote_effective_date" name="promote_effective_date" readonly
                           placeholder="ថ្ងៃ-ខែ-ឆ្នាំ {{ __('label.effective_date') }}" autocomplete="off" value="{{ old('promote_effective_date') }}" required>
                </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6 col-md-6 col-lg-6 @if($errors->has('contract_promote_transfer_to_id')) has-error @endif">
                    <label for="contract_promote_transfer_to_id">Transfer work to (Staff ID) <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="contract_promote_transfer_to_id" id="contract_promote_transfer_to_id"
                           placeholder="{{ __('label.transfer_work_to').' ('.__('label.employee_id').')' }}" value="{{ old('contract_promote_transfer_to_id') }}" required>
                </div>
                ...
                <div class="form-group col-sm-6 col-md-6 col-lg-6 @if($errors->has('contract_promote_get_work_form_id')) has-error @endif">
                    <label for="contract_promote_get_work_form_id">Get work from (Staff ID) <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="contract_promote_get_work_form_id" id="contract_promote_get_work_form_id"
                           placeholder="{{ __('label.get_work_from').' ('.__('label.employee_id').')' }}" value="{{ old('contract_promote_get_work_form_id') }}" required>
                </div>
