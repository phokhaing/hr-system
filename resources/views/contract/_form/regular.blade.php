<div class="row">
    <div class="col-sm-12 col-md-12">
        <form action="{{ route('contract.storeRegular') }}" role="form" method="post" id="create_contract">
            ...
            <div class="row">
                <div class="form-group col-sm-12 col-md-6 col-lg-6 @if($errors->has('contract_regular_start_date')) has-error @endif">
                    <label for="contract_regular_start_date">Contract start date <span class="text-danger">*</span></label>
                    <input type="text" class="form-control pull-right contract_regular_start_date" id="contract_regular_start_date" readonly
                           value="{{ old('contract_regular_start_date') }}" required
                           name="contract_regular_start_date" placeholder="{{ __('label.contract_start_date') }}">
                </div>
                <div class="form-group col-sm-12 col-md-6 col-lg-6 @if($errors->has('contract_regular_end_date')) has-error @endif">
                    <label for="contract_regular_end_date">Contract end date <span class="text-danger">*</span></label>
                    <input type="text" class="form-control pull-right contract_regular_end_date" id="contract_regular_end_date" readonly
                           value="{{ old('contract_regular_end_date') }}" required
                           name="contract_regular_end_date" placeholder="{{ __('label.contract_end_date') }}">
                </div>
            </div> <!-- /.row -->
