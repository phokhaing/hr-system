...
export default {
  ...
  methods: {
    ...
    searchReport() {
      $(".loading").fadeIn("fast");
      axios.get('/report/summary/age-range-and-gender', {
        params: {
    ...
    downloadReport() {
      ...
      axios({
        method: 'get',
        url: '/report/summary/age-range-and-gender/export',
        responseType: 'blob',
        ...
        .then(response => {
          ...
          link.href = url;
          link.setAttribute('download', 'summary_report_age_and_gender.xlsx');
