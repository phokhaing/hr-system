        ...
        <form @submit.prevent>
          <div class="row">
            ...
            <div class="form-group col-sm-6 col-md-6 col-lg-6">
              ...
              <select class="form-control" v-model="contractType" id="contractType">
                <option value="active">Active Contract</option>
                <option value="inactive">In-active Contract</option>
              </select>
            </div>
            <div class="form-group col-sm-6 col-md-6 col-lg-6">
...
export default {
  ...
  methods: {
    ...
    searchReport() {
      $(".loading").fadeIn("fast");
      axios.get('/report/summary/seniority', {
        params: {
    ...
    downloadReport() {
      ...
      axios({
        method: 'get',
        url: '/report/summary/seniority/export',
        responseType: 'blob',
        ...
        .then(response => {
          ...
          link.href = url;
          link.setAttribute('download', 'summary_report_seniority.xlsx');
