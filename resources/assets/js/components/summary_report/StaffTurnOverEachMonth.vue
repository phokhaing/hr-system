...
export default {
  ...
  methods: {
    ...
    searchReport() {
      $(".loading").fadeIn("fast");
      axios.get('/report/summary/staff-turn-over-by-month', {
        params: {
    ...
    downloadReport() {
      ...
      axios({
        method: 'get',
        url: '/report/summary/staff-turn-over-by-month/export',
        responseType: 'blob',
        ...
        .then(response => {
          ...
          link.href = url;
          link.setAttribute('download', 'summary_report_staff_turn_over_each_month.xlsx');
