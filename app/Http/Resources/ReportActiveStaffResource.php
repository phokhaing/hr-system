...
class ReportActiveStaffResource extends Resource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            "back_account" => @$this->staffPersonalInfo->bank_acc_no,
            "bank_name" => @$this->staffPersonalInfo->bank->name_kh,
            "salary" => number_format(@convertSalaryFromStrToFloatValue(@$contract_object->salary), 2) . ' ' . @$contract_object->currency,
