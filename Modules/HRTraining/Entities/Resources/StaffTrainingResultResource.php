...
class StaffTrainingResultResource extends Resource
{
    public function toArray($request)
    {
        ...
        $trainingResult = @$this->traineeResult;
        ...
        return [
            ...
            'total_score' => number_format(@$trainingResult->json_data->total_point, 2),
            'average' => number_format(@$trainingResult->json_data->average, 2),
        ];
    }
