                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="trainee_progress" value="{{ TRAINING_CONSTANT_TYPE['TRAINEE_PROGRESS_RE_TAKEN'] }}"
                                                {{ @$trainee->training_status == TRAINING_CONSTANT_TYPE['TRAINEE_PROGRESS_RE_TAKEN'] ? 'checked' : '' }}/>
                                        {{ getTraineeProgressStatus(TRAINING_CONSTANT_TYPE['TRAINEE_PROGRESS_RE_TAKEN']) }}
                                    </label>
                                </div>
                            </div>
                        </div>
