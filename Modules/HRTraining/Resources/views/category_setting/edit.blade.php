...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><label for="">Edit Category</label></div>
        <div class="panel-body">
            {{ session()->get('message') }}
            <div class="row">
                <div class="col-sm-12">
                    <form action="{{ route('hrtraining::category.update', $category->id) }}" method="POST">
                        {{ Form::token() }}
                        <div class="row">
                                <div class="form-group col-sm-6 col-md-6 @if($errors->has('title_en')) has-error @endif">
                                    ...
                                    form_text([
                                        ...
                                        'class' => 'form-control',
                                        'id' => 'title_en',
                                        'value' => @$category->json_data->title_en
                                    ]);
                                    ?>
                                </div>
                                <div class="form-group col-sm-6 col-md-6 @if($errors->has('title_kh')) has-error @endif">
                                    ...
                                    form_text([
                                        ...
                                        'class' => 'form-control',
                                        'id' => 'title_kh',
                                        'value' => @$category->json_data->title_kh
                                    ]);
                                    ?>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 @if($errors->has('desc_en')) has-error @endif">
                                    ...
                                    form_textarea([
                                        ...
                                        'id' => 'desc_en',
                                        'value' => @$category->json_data->desc_en
                                    ]);
                                    ?>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 @if($errors->has('desc_kh')) has-error @endif">
                                    ...
                                    form_textarea([
                                        ...
                                        'class' => 'summernote form-control',
                                        'id' => 'desc_kh',
                                        'value' => @$category->json_data->desc_kh
                                    ]);
                                    ?>
                                </div>
