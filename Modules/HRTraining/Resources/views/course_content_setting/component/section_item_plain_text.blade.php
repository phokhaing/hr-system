        ...
        <div class="">
            ...
            <div>
                ...
                <span id="section_item_type" class="section_item_type">
                     {{ COURSE_CONTENT_TYPE_KEY[1]
                }}
                </span>
            </div>

            <p class="max-line section_desc" id="section_desc">{{ @$section->description ?: 'N/A' }}</p>

{{--            <p class="max-line section_plain_text" id="section_plain_text">{!!  @$section->plain_text  !!}</p>--}}
